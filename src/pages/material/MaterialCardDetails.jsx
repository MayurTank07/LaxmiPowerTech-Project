...
export default function MaterialCardDetails() {
  ...
  // Material editing state - track which specific material is being edited
  ...
  // Individual material save handler
  const handleSaveMaterial = async (materialId) => {
    const material = formData.materials.find(m => m.id === materialId);
    
    // Validate material is complete
    if (!material.category || !material.subCategory || !material.subCategory1 || !material.subCategory2 || !material.quantity) {
    ...
    try {
      ...
      const updateData = {
        fromSite: formData.fromSite || transfer.fromSite,
        toSite: formData.toSite || transfer.toSite,
        requestedBy: formData.requestedBy || transfer.requestedBy,
        status: formData.status || transfer.status,
  ...
  const removeMaterialRow = async (id) => {
    ...
    try {
      ...
      const updatedMaterials = formData.materials.filter(m => m.id !== id);
  ...
  // Unified View - Materials use MaterialLineItem for individual editing
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-blue-50">
      ...
      <div className="max-w-md mx-auto min-h-screen bg-white shadow-xl">
        ...
        <div className="px-6 py-6 -mt-4 pb-24">
          ...
          {/* Materials Section - Individual Editing with MaterialLineItem */}
          <div className="mb-4">
            ...
            <div className="space-y-3">
              {formData.materials?.map((material, index) => (
                <MaterialLineItem
                  ...
                  onDoneEditing={() => handleSaveMaterial(material.id)}
        ...
        {/* Fixed Bottom Button - Only Delete */}
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg p-4 z-50">
          <div className="max-w-md mx-auto">
            <button
              onClick={handleDelete}
              className="w-full py-3 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors text-sm font-medium"
            >
              Delete Transfer
            </button>
          </div>
