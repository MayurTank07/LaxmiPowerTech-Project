          ...
          <div className="px-4 py-4">
            ...
            <div className="mb-3">
              ...
              >
                <option value="">Select Site</option>
                {sites
                  .filter(site => site !== formData.fromSite) // ✅ Exclude selected From Site
                  .map((site, index) => (
                    <option key={index} value={site}>
                      {site}
                    </option>
            ...
            {/* ✅ Cloudinary Image Preview Gallery */}
            {attachments.length > 0 && (
              <div className="mb-6">
                <p className="text-xs text-gray-600 mb-2 font-medium">{attachments.length} file(s) selected</p>
